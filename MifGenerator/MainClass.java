...
public class MainClass {
    ...
    public void miffile(String args){
        try{
            ...
            System.out.println("Enter the name the mif file will have (without extension):");
    ...
    public void imagefile(String[] args){
        try {
            ...
            if (word > 131072){//65536) {
                throw new ExceptionInInitializerError();
            }
            if (word == 0) {

                if (mem_used > 131072){//65536) {
                    throw new ExceptionInInitializerError();
                } else if (mem_used > 65536) {                  //line added
					word = 131072;								//line added
